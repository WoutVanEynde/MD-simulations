...
#STEP 3: add following line into em.mdp, nvt.mdp, npt.mdp and md.mdp files
...
gmx grompp -f npt.mdp -c nvt.gro -r nvt.gro -t nvt.cpt -p topol.top -o npt.tpr -n index.ndx -maxwarn 1 -quiet
