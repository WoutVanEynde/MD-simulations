...
#Protein.pdb file is prepared and energy-minimized
#L1.mol2 file is in the working directory and is named properly in second line and in second last column!
...
#STEP 7: include ligand topology to topol.top, manually if more ligands present!
...
#STEP 21: energy minimization and generate potential file
...
#tc-grps = Protein_DNA_L1 Water_and_ions
