...
gmx anaeig -f md_noPBC_whole_nojump_center_mol_com_fit.xtc -v eigenvec.trr -eig eigenval.xvg -s md.tpr -proj proj_1_2.xvg -b 0 -e 150000 -first 1 -last 1 << EOL
C-alpha
C-alpha
EOL
...
gmx anaeig -f md_noPBC_whole_nojump_center_mol_com.xtc -v eigenvec.trr -eig eigenval.xvg -s md.tpr -2d 2dproj_1_2.xvg  -b 0 -e 150000 -first 1 -last 2 <<EOL
C-alpha
C-alpha
EOL
vim 2dproj_1_2.xvg
...
#STEP 7: porcupine
gmx anaeig -v eigenvec.trr -s md.tpr -f md_noPBC_whole_nojump_center_mol_com.xtc -b 0 -e 200000 -first 1 -last 1 -extr extreme1.pdb -nframes 1500 <<EOL
C-alpha
C-alpha
EOL
...
load md.gro
load md_noPBC_whole_nojump_center_mol_com_fit.xtc
remove solvent
select resn Na
remove sele
split_states md, 1, 2
split_states md, 2000, 2001
set_name md_0001, 0001
set_name md_2001, 2001
delete md_0002
delete md_2000
sele resn CYM
alter sele, resn='CYS'
run modevectors.py
modevectors 0001, 2001, cutoff=.0, head_length=2, head=0.4, headrgb=(1,.2,.1) ,tailrgb=(1,.2,.1) ,notail=0
bg_color black
